...
function Resume() {
  ...
  <div className="border-1 shadow-lg shadow-black rounded-lg">
    {/* top content */}
    <div className="flex rounded-t-lg bg-zinc-900 sm:px-2 w-full">
      <div className="h-40 w-40 overflow-hidden sm:rounded-full sm:relative sm:p-0 top-10 left-5 p-3">
        <img src="/image/dp.jpg" />
      </div>
      <div className="w-2/3 sm:text-center pl-5 mt-10 text-start">
        <p className="font-poppins font-bold text-red-700 sm:text-4xl text-2xl">
          Kishan Pandit
        </p>
        <p className="text-heading">Full-Stack Developer</p>
      </div>
    </div>
    {/* main content */}
    <div className="p-5">
      <div className="flex flex-col sm:flex-row sm:mt-10">
        <div className="flex flex-col sm:w-1/3">
          ...
          <div className="py-3 sm:order-none order-3">
            <h2 className="text-lg font-poppins font-bold text-red-700">
              My Contact
            </h2>
            <div className="border-2 w-20 border-top-color my-3" />
            <div>
              <div className="flex items-center my-1">
                <a className="w-6 text-white hover:text-orange-600">
                  <svg
                ...
                <div className="ml-2 truncate">Kishanxcode@gmail.com</div>
              </div>
              <div className="flex items-center my-1">
                <a
                  className="w-6 text-white hover:text-orange-600"
          ...
          <div className="py-3 sm:order-none order-2">
            ...
            <div>
              <div className="flex items-center my-1">
                <a className="w-6 text-gray-100 hover:text-orange-600">
                  <svg
                    viewBox="0 0 15 15"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="py-3 sm:order-none order-1">
            ...
            <div className="flex flex-col space-y-1">
              <div className="flex flex-col">
                <p className="font-semibold text-xs text-gray-300">2021-24</p>
                <p className="text-sm font-medium">
                  <span className="text-red-700">
                    B.Sc (PHYSICS HONORS)
                  </span>
                  , MADHUPUR COLLAGE , MADHUPUR.
                </p> 
              ...
              <div className="flex flex-col">
                <p className="font-semibold text-xs text-gray-300">2020-21</p>
                <p className="text-sm font-medium">
                  <span className="text-red-700">ISC</span>, CHITRA
                  COLLEGE, CHITRA.
                </p>
                <p className="font-bold text-xs text-gray-300 mb-2">
                  Percentage: 62.79
              ...
              <div className="flex flex-col">
                <p className="font-semibold text-xs text-gray-300">2019</p>
                <p className="text-sm font-medium">
                  <span className="text-red-700">10+</span>, SUN RAYS HIGH
                  SCHOOL, PALAJORI.
                </p>
                <p className="font-bold text-xs text-gray-300 mb-2">
                  Percentage: 93.80
          ...
          <div className="py-3">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col">
                ...
                <p className="font-semibold text-sm text-gray-300 mt-2 mb-1">
              ...
              <div className="flex flex-col mt-8">
                ...
                <p className="font-semibold text-sm text-gray-300">2020-2021</p>
                <p className="font-semibold text-sm text-gray-300 mt-2 mb-1">
                  Key Responsibilities
                </p>
                <ul className="text-sm list-disc pl-4 space-y-1">
          ...
          <div className="py-3">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col">
                ...
                <p className="font-normal text-sm text-gray-300 mb-1 pl-2">
