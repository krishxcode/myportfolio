...
function Header() {
  return (
    <header className="font-sans w-full h-[10vh] m-0 px-3 md:px-0 sticky top-0 z-50 transition-shadow duration-300 ease-in-out shadow-lg">
      <div className="bg-zinc-900 text-white">
        <div className="container mx-auto px-8 md:px-8">
          <div className="flex items-center justify-between py-4">
            ...
            <nav data-aos="zoom-in" className="hidden sm:flex sm:items-center ">
              <NavLink
                to="/"
                className="text-white text-[18px] font-semibold hover:text-red-600 mr-6"
              >
                Home
              </NavLink>
              <NavLink
              ...
              <a
                href="/"
                className="text-white text-[18px] font-semibold hover:text-red-600"
              >
                Other Page
              </a>
            </nav>
            <div className="hidden sm:flex sm:items-center">
              <NavLink
                ...
                className="text-white bg-red-600 text-sm font-semibold px-4 py-2 md:py-3 rounded-lg hover:border-red-600"
              >
                Download CV
              </NavLink>
            </div>
